...
// 생성
productsRouter.post('', needSignin, productController.createdProduct);
// async (req, res) => {
// try {
...
// 수정
productsRouter.put('/:productId', needSignin, productController.updateProduct);
// needSignin, async (req, res) => {
//   try {
//     const { productId } = req.params;
